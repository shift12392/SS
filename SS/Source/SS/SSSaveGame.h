 ...
 */
UCLASS()
class SS_API USSSaveGame : public USaveGame
{
	GENERATED_BODY()
...
public:
	...
	TMap<FPrimaryAssetId, FSSItemData> InventoryData;

	/** Map of slotted items */
	UPROPERTY(VisibleAnywhere, BlueprintReadWrite, Category = SaveGame)
	TMap<FSSItemSlot, FPrimaryAssetId> SlottedItems;
