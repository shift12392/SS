 ...
 */
UCLASS()
class SS_API USSGameInstance : public UGameInstance
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = Inventory)
		TMap<FPrimaryAssetId, FSSItemData> DefaultInventory;
	...
	*/
	UFUNCTION(BlueprintCallable, Category = Inventory)
		void AddDefaultInventory(USSSaveGame* SaveGame, bool bRemoveExtra = false);

	/** Returns true if this is a valid inventory slot */
	UFUNCTION(BlueprintCallable, Category = Inventory)
		bool IsValidItemSlot(FSSItemSlot ItemSlot) const;
	...
	UFUNCTION(BlueprintCallable, Category = Save)
		USSSaveGame* GetCurrentSaveGame();
