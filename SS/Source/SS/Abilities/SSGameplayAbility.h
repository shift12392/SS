 ...
 */
UCLASS()
class SS_API USSGameplayAbility : public UGameplayAbility
{
	GENERATED_BODY()
...
public:
	...
	TMap<FGameplayTag, FSSGameplayEffectContainer> EffectContainerMap;

	/** Make gameplay effect container spec to be applied later, using the passed in container */
	UFUNCTION(BlueprintCallable, Category = Ability, meta = (AutoCreateRefTerm = "EventData"))
	virtual FSSGameplayEffectContainerSpec MakeEffectContainerSpecFromContainer(const FSSGameplayEffectContainer& Container, const FGameplayEventData& EventData, int32 OverrideGameplayLevel = -1);
